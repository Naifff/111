...
> Открыть эту страницу в [https://naifff.github.io/111/](https://naifff.github.io/111/)
...
* найдите **https://github.com/naifff/111** и импортируйте

## Править этот проект ![Значок статуса сборки](https://github.com/naifff/111/workflows/MakeCode/badge.svg)

Редактировать этот репозиторий в MakeCode.

* открыть [https://makecode.microbit.org/](https://makecode.microbit.org/)
* нажмите на **Импорт**, затем **Импорт URL**
* вставьте **https://github.com/naifff/111** и нажмите Импорт
...
![Отрисовка в виде блоков](https://github.com/naifff/111/raw/master/.github/makecode/blocks.png)
